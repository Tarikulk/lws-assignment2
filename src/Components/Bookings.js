...
import { deleteBooking } from '../redux/bookingsActions/action';
    ...
    return (
      ...
      <table class="booking-table">
        <thead class="bg-gray-100/50">
          {
            bookings.length > 0 && <tr class="text-black text-left">
        ...
        <tbody class="divide-y divide-gray-300/20" id="lws-previewBooked">
          {/* <!-- Row 1 --> */}
          {
            bookings?.map(booking => <tr class="lws-bookedTable text-black">
            <td class="px-6 py-4">
            ...
            <td class="px-6 py-4 text-center">
              <div class="flex justify-center gap-4">
                <button class="lws-remove" onClick={() => handleDelete(booking.id)}>
